...
t1 <- tableone::CreateTableOne(data=surv.dat %>% select(-1, 
                                                               -c(55:59),   # clusters
                                                               -c(60:76)),  # outcomes
                               factorVars = fctrs)
...
t2 <- CreateTableOne(data=surv.dat %>% select(-1,   # "V_rapID" 
                                              -55,  # clusters_2
                                              -c(57:63),  # other clusters and outcomes until overall mortality
                                              -c(65:76)), # all other outcomes
                     strata = "clusters_3", 
...
t4 <- CreateTableOne(data=surv.dat %>% select(-1,   # "V_rapID" 
                                              -c(55:56),  # clusters_2
                                              -c(58:63),  # other clusters and outcomes until overall mortality
                                              -c(65:76)), # all other outcomes
                     strata = "clusters_4", 
                     #vars = colnames(surv.dat)[-c(4,5,15,16)],
                     factorVars = fctrs)
